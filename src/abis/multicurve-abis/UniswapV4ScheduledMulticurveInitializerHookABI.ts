export const UniswapV4ScheduledMulticurveInitializerHookABI = [
  {
    inputs: [
      {
      ...
      {
        internalType: "contract UniswapV4ScheduledMulticurveInitializer",
        name: "initializer",
        type: "address",
      },
    ],
  ...
  { inputs: [], name: "CannotSwapBeforeStartingTime", type: "error" },
  { inputs: [], name: "HookNotImplemented", type: "error" },
  { inputs: [], name: "NotPoolManager", type: "error" },
  { inputs: [], name: "OnlyInitializer", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
